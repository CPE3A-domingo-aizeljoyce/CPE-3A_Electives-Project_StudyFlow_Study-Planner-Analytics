    ...
    <div draggable onDragStart={handleDragStart}
      ...
      <div className="flex items-start gap-2 mb-2.5">
        ...
        <div className="flex gap-1 shrink-0">
          <button onClick={(e) => { e.stopPropagation(); onToggle(task.id); }} title={isDone ? 'Mark as to-do' : 'Mark as done'}
          ...
          <button onClick={(e) => { e.stopPropagation(); onRemove(task.id); }} title="Delete"
      ...
      <div className="flex items-center flex-wrap gap-1.5">
        ...
        {moveCols.map(col => (
          <button key={col.id} onClick={(e) => { e.stopPropagation(); onMoveCol(task.id, col.id); }}
  ...
  return (
    <div className="flex flex-col w-full min-w-0">
      <div className="flex items-center justify-between mb-3 px-1">
        ...
        {col.id === 'todo' && (
          <button onClick={onAdd} className="w-6 h-6 rounded-lg flex items-center justify-center shrink-0" title="Add task"
            ...
            {editingGoal ? (
              ...
              <div className="flex-1 flex items-start gap-2 group">
                <p className="text-xs flex-1 leading-relaxed"
                  style={{ color: sprintGoals[selectedSprint] ? colors.textSub : colors.textMuted, fontStyle: sprintGoals[selectedSprint] ? 'normal' : 'italic' }}>
                ...
                <button onClick={startEdit}
                  ...
                  style={{ background: colors.card2, color: colors.textMuted, border: `1px solid ${colors.border}` }} title="Edit sprint goal">
